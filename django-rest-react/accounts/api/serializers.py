...
class UserImageDetailsUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ['profile_pic']
...
class UserDetailsUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['role', 'batting_style', 'bowling_style', 'gender', 'location', 'date_of_birth']

    def validate_date_of_birth(self, value):
        # Example validation: ensure the date is in the past
        if value:
